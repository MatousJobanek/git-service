...
func NewRepositoryService(gitSource *git.Source) (repository.Service, error) {
	storage := memory.NewStorage()
	return newRepositoryService(gitSource, storage)
}

func newRepositoryService(gitSource *git.Source, storage storage.Storer) (*RepositoryService, error) {
